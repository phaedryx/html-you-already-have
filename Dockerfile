...
# docker build -t html_you_already_have .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name html_you_already_have html_you_already_have
